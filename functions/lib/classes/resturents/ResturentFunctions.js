...
class ResturentFunctions {
}
ResturentFunctions.register = (resturentsDB, usersDB, enterpriseDB, req, res) => {
    const data = req.body;
...
ResturentFunctions.loginWithUserName = (resturentsDB, req, res) => {
    const data = req.body;
...
exports.default = ResturentFunctions;
//# sourceMappingURL=ResturentFunctions.js.map